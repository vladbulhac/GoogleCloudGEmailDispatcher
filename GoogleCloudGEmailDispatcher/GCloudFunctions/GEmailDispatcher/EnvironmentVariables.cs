...
namespace EmailDispatcher
{
    public static class EnvironmentVariables
    {
        ...
        public static string NAMEOF_OAUTHINIT_GCLOUD_FUNCTION { get; }

        public static string GCLOUD_FUNCTION_OAUTHINIT_URL { get; }
        ...
        static EnvironmentVariables()
        {
            ...
            NAMEOF_OAUTHINIT_GCLOUD_FUNCTION = Environment.GetEnvironmentVariable(nameof(NAMEOF_OAUTHINIT_GCLOUD_FUNCTION)) ?? throw new ArgumentNullException(nameof(NAMEOF_OAUTHINIT_GCLOUD_FUNCTION));

            GCLOUD_FUNCTION_OAUTHINIT_URL = $"https://{GCLOUD_FUNCTION_REGION}-{GCLOUD_FUNCTION_PROJECT_ID}.cloudfunctions.net/{NAMEOF_OAUTHINIT_GCLOUD_FUNCTION}";
